            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Informasi Akademik</h4>
							        ...
							        <div class="col-lg-12">
							            <div class="card">
							                <div class="card-header align-items-center d-flex bg-light">
							                    <h4 class="card-title mb-0 flex-grow-1">Input Informasi Akademik</h4>
							                </div><!-- end card header -->
							                <div class="card-body">
															...
															<div class="row g-2">
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  ...
									                                  <label for="jdlInfo">Judul Informasi</label>
									                                </div>
															 	</div>
																...
																<div class="col-xxl-6 col-md">
																	<div class="mb-3">
																		...
																		<input class="form-control" type="file" id="fileakademik" onchange="subapp.upload()">
									                            ...
									                            <div class="col-xxl-6 col-md-6">
									                                <div class="form-floating mb-2">
									                                    <textarea class="form-control" placeholder="Tulis deskripsi Informasi" id="ketinfo"></textarea>
									                                    <label for="ketInfo">Keterangan</label>
									                                </div> 
									                            </div>                   
															</div> 
								                        </div>
		        ...
		        <div class="col-lg-12">
		            <div class="card">
						<div class="card-header align-items-center bg-light d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Info Akademik</h4>
