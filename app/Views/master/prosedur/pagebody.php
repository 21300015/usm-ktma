            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Pedoman  &amp; Prosedur</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Pedoman  &amp; Prosedur</li>
                            </ol>
                        </div>
							        ...
							        <div class="col-lg-12">
							            <div class="card">
							                <div class="card-header align-items-center d-flex bg-light">
							                    <h4 class="card-title mb-0 flex-grow-1">Input Pedoman  &amp; Prosedur</h4>
							                </div><!-- end card header -->
							                <div class="card-body">
															...
															<div class="row g-2">
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="jdlprosedur" placeholder="" value="">
									                                  <label for="jdlprosedur">Judul Pedoman  &amp; Prosedur</label>
									                                </div>
															 	</div>
									                            <div class="col-xxl-6 col-md-6">
									                                <div class="form-floating mb-2">
									                                    <textarea class="form-control" placeholder="Tulis deskripsi Informasi" id="deskprosedur"></textarea>
									                                    <label for="deskprosedur">Deskripsi</label>
									                                </div> 
									                            </div>
		                                                        <div class="col-xxl-6 col-md-6">
		                                                            <div>
																...
																<div class="col-xxl-6 col-md">
																	<div class="mb-3">
																		...
																		<input class="form-control" type="file" id="fileprosedur" onchange="subapp.upload()">
									                            ...
									                            <div class="col-xxl-6 col-md-6">
									                                <div class="form-floating mb-2">
									                                    <textarea class="form-control" placeholder="Tulis deskripsi Informasi" id="ketprosedur"></textarea>
									                                    <label for="ketprosedur">Keterangan</label>
									                                </div> 
									                            </div>                   
															</div> 
								                        </div>
		        ...
		        <div class="col-lg-12">
		            <div class="card">
						<div class="card-header align-items-center bg-light d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Pedoman & Prosedur</h4>
		                    ...
		                    <table id="tabelutama" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
		                        <thead>
		                            <tr>
		                                ...
		                                <th data-ordering="false">Judul Pedoman & Prosedur</th>
		                                <th data-ordering="false">Deskripsi Pedoman & Prosedur</th>               
