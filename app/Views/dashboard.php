                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Data Obat</p>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="559"></span>&nbsp; Item </h4>
                                                        <a href="" class="text-decoration-underline">View detail</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <span class="avatar-title bg-soft-primary rounded fs-3">
                                                            <i class="bx bx-band-aid text-primary"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Data Obat</h4>
                                            </div><!-- end card header -->

                                            <div class="card-body">
                                                <div class="table-responsive table-card">
                                                    <table class="table table-striped-columns table-hover table-centered align-middle table-nowrap mb-0">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-14 my-1 fw-normal">B02320</h5>
                                                                </td>
                                                                <td>
                                                                    <div class="d-flex align-items-center">          
                                                                        <div>
                                                                            <h5 class="fs-14 my-1"><a href="#" class="text-reset">Actived</a></h5>
                                                                            <span class="text-muted">Obat Keras</span>
                                                                        </div>
                                                                    </div>
                                                                </td>                                                                
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <h5 class="fs-14 my-1 fw-normal">Botol</h5>
                                                                </td>
                                                                <td>Action
                                                                </td>
                                                            </tr>
