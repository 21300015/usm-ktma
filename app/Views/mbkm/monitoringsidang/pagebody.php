            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Monitoring Skripsi/TA</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Monitoring Skripsi/TA</li>
                            </ol>
                        </div>
							                        ...
							                        <div class="row gy-2">
							                        	<form method="post" id="fmutama">
															...
															<div class="row g-2">
																...
																<!--div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="stupen" placeholder="" value="">
									                                  <label for="stupen">Studi Independen/KP/MBKM</label>
									                                </div>
															 	</div-->
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="sempro" placeholder="" value="">
									                                  <label for="sempro">Seminar Proposal</label>
									                                </div>
															 	</div>
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="sidang" placeholder="" value="">
									                                  <label for="sidang">Sidang Skripsi</label>
									                                </div>
															 	</div>
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="revisi" placeholder="" value="">
									                                  <label for="revisi">Revisi Sidang</label>
									                                </div>
															 	</div>
																<div class="col-xxl-6 col-md">
									                                <div class="form-floating mb-2">
									                                  <input type="text" class="form-control" id="nilaiskripsi" placeholder="" value="">
																...
																<!--div class="col-xxl-6 col-md">
																	<div class="mb-3">
																		...
																		<input class="form-control" type="file" id="filehasilskripsi" onchange="subapp.upload()">
		        ...
		        <div class="col-lg-12">
		            <div class="card">
						<div class="card-header align-items-center bg-light d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Monitoring Skripsi/TA</h4>
		                    ...
		                    <table id="tabelutama" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
		                        <thead>
		                            <tr>
		                                ...
		                                <th data-ordering="false">Judul Skripsi</th>
		                                <th data-ordering="false" class="text-wrap">Dosen Pembimbing</th>
		                                <!--th data-ordering="false" class="text-wrap">Studi Independen/KP</th-->
		                                <th data-ordering="false" class="text-wrap">Seminar Proposal</th>
		                                <th data-ordering="false">Sidang</th>
		                                <th data-ordering="false">Revisi</th>
		                                <th data-ordering="false" class="text-wrap">Nilai Skripsi</th>
		                                <!--th>Action</th-->
		                            </tr>
		                        </thead>
		                        <tbody>			                                                 					                            
