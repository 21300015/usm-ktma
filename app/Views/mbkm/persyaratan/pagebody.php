        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card rounded-0 bg-soft-primary mx-n4 mt-n4 border-top border-0 card-border-effect-none">
                                <div class="px-4">
                                    <div class="row">
                                    ...
                                    <div class="mt-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="fs-16 mb-0 fw-semibold">01. Persyaratan Umum</h5>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="mt-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="fs-16 mb-0 fw-semibold">02. Seminar Proposal Skripsi</h5>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="mt-3">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="fs-16 mb-0 fw-semibold">03. Sidang Skripsi</h5>
                                            </div>
                                        </div>
